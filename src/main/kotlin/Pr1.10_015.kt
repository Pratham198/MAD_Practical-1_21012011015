...
fun main() {
    var car1 = Car("BMW",2018, 100000.0,98950.0, "Pratham",105 )
    var car2 = Car("BMW",2019, 400000.0,399800.0, "Deep",20 )
    car1.displayCarInfo()
    car2.displayCarInfo()

    var cars = ArrayList<Car>()
    cars.add(Car("Toyota",2017, 1080000.0,1079000.0, "Parth",100 ))
    cars.add(Car("Maruti",2020, 4000000.0,3998000.0, "Het",200 ))
